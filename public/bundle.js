	...
	var Main = React.createClass({
	  ...
	  componentDidUpdate: function componentDidUpdate(prevProps, prevStates) {
	    if (prevStates.searchTopic !== "6") {
	      ...
	      _helpers2.default.runQuery(this.state.searchTopic).then(function (data) {
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        "div",
	        { className: "col-md-6" },
	        React.createElement(Results, { searchTopic: this.state.searchTopic })
	      )
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var queryURL = "https://api.nytimes.com/svc/search/v2/articlesearch.json?api-key=53567ecab3d5401b9ef7333adaad3204&q=";
