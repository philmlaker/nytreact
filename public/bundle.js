	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              "em",
	              null,
	              "Enter a topic to search for articles."
	            )
	          )
	        ),
	        React.createElement(
	...
	var helper = {
	    ...
	    runQuery: function runQuery(location) {
	        ...
	        return axios.get(queryURL).then(function (res) {
	            ...
	            for (var i = 0; i < 5; i++) {
	                var titleResult = res.data.response.docs[i].headline.main;
	                var urlResult = res.data.response.docs[i].web_url;
